  ...
  _adminModals(R, d, s, wrap) {
    ...
    if (k === 'clientProfile') {
      ...
      if (editing) {
        ...
        return wrap('Edit client — ' + c.name, e('div', { style: { display: 'flex', flexDirection: 'column', gap: 14 } },
          ...
          UI.Grid('1fr 1fr', 12,
            ...
            UI.Field('Rate / appt (€)', UI.Input(String(f.editRate !== undefined ? f.editRate : c.rate), v => this.setForm('editRate', v), '45', 'number'))),
          UI.Grid('1fr 1fr', 12,
      ...
      return wrap(c.name, e('div', { style: { display: 'flex', flexDirection: 'column', gap: 16 } },
        ...
        e('div', null,
          UI.Row({ justifyContent: 'space-between', marginBottom: 7 }, UI.Sub('Contracts'), UI.Btn('+ New', () => { this.closeModal(); this.openModal('wizard', { step: 0, partyType: 'client', company: c.name, email: c.email || '', contact: c.contactPerson || '', vat: c.vat || '' }); }, 'ghost', { padding: '3px 10px', fontSize: 11 })),
