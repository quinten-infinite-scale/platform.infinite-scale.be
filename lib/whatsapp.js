...
export function normalizePhone(raw) {
  ...
  // Belgian/Dutch local: starts with 0 (04xx mobile BE, 0x landline)
  if (digits.startsWith('0')) {
    return '+32' + digits.slice(1);
  }
  // 9-digit number without leading zero = Belgian mobile missing the leading 0 (e.g. 471125002)
  if (digits.length === 9) return '+32' + digits;
